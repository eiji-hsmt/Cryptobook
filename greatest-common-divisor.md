...
となるが[^3], $$b$$ の倍数 $$\{ \cdots , -3b, -2b, -b, 0, b, 2b, 3b, \cdots \}$$ のうち, $$-b \lt r - r^\prime \lt b$$ を満たす数は $$0$$ しか存在しないため, $$r - r^\prime = 0$$ すなわち $$r = r^\prime$$ となるが, このとき右辺が $$0$$ となり かつ 左辺が $$0$$ とならないため不適.
